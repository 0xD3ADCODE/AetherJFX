...
set VSVER=150
set "VSVARS32FILE=C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvars32.bat"
if not "%VS150COMNTOOLS%"=="" (
    set "VS150COMNTOOLS=%VS150COMNTOOLS%"
) else (
  if exist "%VSVARS32FILE%" set "VS150COMNTOOLS=C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build"
)
